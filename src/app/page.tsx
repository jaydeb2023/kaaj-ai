...
import { ArrowRight, Users, Star, Zap, Shield, Globe, MessageCircle } from 'lucide-react'

// Sample conversations shown on flip cards
const FLIP_AGENTS = [
  {
    name: 'Dokan Manager',
  ...
  },
  {
    ...
    chat: [
      ...
      { role: 'assistant', text: '⚠️ ৩টি medicine এর মেয়াদ আগামী ৩০ দিনে শেষ: Cough Syrup (৮টি), Vitamin C (২০টি), Antacid (১২টি)। এখনই সরিয়ে রাখুন।' },
    ],
  },
  {
    name: 'Puja Organizer',
    ...
    chat: [
      ...
      { role: 'assistant', text: 'মোট বাজেট ₹২,৪০,০০০। এখন পর্যন্ত স্পনসর থেকে ₹১,৬৫,০০০ এসেছে। বাকি ₹৭৫,০০০ এর জন্য ৩ জন sponsor এখনো pending।' },
      { role: 'user',      text: 'প্রতিমার বায়না দেওয়া হয়েছে?' },
      { role: 'assistant', text: '✅ হ্যাঁ! কুমোরটুলির মৃৎশিল্পী রবিদাকে ₹৩৫,০০০ বায়না দেওয়া হয়েছে। বাকি ₹১৫,০০০ delivery-র দিন। আর ৪৫ দিন বাকি!' },
    ],
  },
  {
    ...
    chat: [
      ...
      { role: 'assistant', text: '১২ জন ছাত্র এখনো এই মাসের ফি দেয়নি। মোট বাকি ₹১৮,০০০। সবার অভিভাবককে WhatsApp reminder পাঠানো হোক?' },
      { role: 'user',      text: 'রিয়ার পরীক্ষার result কী?' },
      { role: 'assistant', text: 'রিয়া শেষ ৩টি mock test-এ পেয়েছে: ৭৮, ৮২, ৮৮। ধীরে ধীরে উন্নতি হচ্ছে! Math এ একটু বেশি মনোযোগ দরকার।' },
    ],
  },
]
  ...
  return (
    ...
    >
      ...
      >
        {/* FRONT */}
        <div
          className="absolute inset-0 rounded-2xl border border-gray-200 p-6 flex flex-col justify-between bg-white"
        ...
        >
          ...
          <div className="flex items-center gap-2 text-gray-400 text-xs">
            ...
            <span className="bengali">hover করুন — কথোপকথন দেখুন</span>
          </div>
        </div>

        {/* BACK — sample chat */}
        <div
          className="absolute inset-0 rounded-2xl border p-4 flex flex-col bg-white overflow-hidden"
          style={{
        ...
        >
          <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-100">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center text-sm"
              style={{ background: agent.color }}>{agent.icon}</div>
            <span className="text-xs font-semibold text-gray-700 bengali">{agent.name_bn}</span>
          </div>
          <div className="flex-1 flex flex-col gap-2 overflow-hidden">
            {agent.chat.slice(0, 4).map((msg, i) => (
              <div key={i}
                className={`text-[11px] leading-relaxed px-2.5 py-1.5 rounded-xl max-w-[90%] bengali ${
                  msg.role === 'user'
                    ? 'self-end bg-gray-100 text-gray-700'
          ...
          <Link href="/library"
            className="mt-2 text-center text-xs font-semibold py-1.5 rounded-lg transition-colors text-white"
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-b border-gray-200 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-indigo-50 text-indigo-700 text-xs font-semibold px-4 py-2 rounded-full border border-indigo-100 mb-8">
            ...
            ১০০% বিনামূল্যে · বাংলার ব্যবসার বিশ্বস্ত সঙ্গী · West Bengal &amp; Bangladesh
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-4">
            ...
            <p className="text-gray-500 text-lg bengali">
              যেকোনো card-এ <span className="text-indigo-600 font-semibold">hover</span> করুন — সরাসরি কথোপকথন দেখুন
            </p>
          </div>
          {/* hover hint pill */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {FLIP_AGENTS.map((agent, i) => (
              <FlipCard key={i} agent={agent} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
            ...
            {PREBUILT_AGENTS.filter(a => a.is_featured).map((agent, i) => {
              ...
              return (
                <Link key={i} href="/library"
                  ...
                  style={{ borderTop: `3px solid ${agent.color === '#EEF2FF' ? '#4F46E5' : '#6366f1'}` }}>
          ...
          <div className="text-center mt-8">
            <Link href="/library"
              className="inline-flex items-center gap-2 px-6 py-3 border border-indigo-200 text-indigo-600 font-semibold rounded-xl hover:bg-indigo-50 transition-colors bengali">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { n: '২', t: 'AI এজেন্ট তৈরি হবে',  d: 'সহায়ক AI আপনার চাহিদা বুঝে স্বয়ংক্রিয়ভাবে একটি কাস্টম এজেন্ট তৈরি করবে।'          },
              { n: '৩', t: 'বাংলায় chat করুন',     d: 'আপনার এজেন্টের সাথে বাংলায় কথা বলুন — বা মাইক্রোফোনে বলুন। সে মনে রাখবে, সাহায্য করবে।' },
            ].map(s => (
      ...
      <section className="py-20 px-4 bg-indigo-50 border-y border-indigo-100">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              { q: '"আমার মুদি দোকানের বাকির হিসাব রাখা এখন অনেক সহজ। রোজ রাতে একবার বললেই সব হিসাব দিয়ে দেয়!"', name: 'রামপ্রসাদ মণ্ডল',     role: 'মুদি দোকান মালিক, বালিগঞ্জ',      init: 'র' },
              ...
              { q: '"ফার্মেসিতে ওষুধের মেয়াদ track করা এখন সহজ। মেয়াদ শেষের আগেই সহায়ক alert দেয়!"',               name: 'মোঃ রফিকুল ইসলাম', role: 'ফার্মেসি মালিক, ঢাকা',            init: 'র' },
            ].map(t => (
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: <Globe className="text-indigo-600" size={24} />,  t: '১০০% বাংলায়',      d: 'সম্পূর্ণ বাংলা ভাষায় কথা বলুন — এমনকি মাইক্রোফোনে। Kolkata slang থেকে literary Bangla — সব বোঝে।' },
